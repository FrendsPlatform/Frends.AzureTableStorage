...
internal class ErrorHandlerTest : TestBase
{
    ...
    public void Should_Throw_Error_When_ThrowErrorOnFailure_Is_True()
    {
        ...
        Func<Task> action = async () => { await AzureTableStorage.CreateTable(input, connection, options, CancellationToken.None); };
    ...
    public async Task Should_Return_Failed_Result_When_ThrowErrorOnFailure_Is_False()
    {
        ...
        var result = await AzureTableStorage.CreateTable(input, connection, options, CancellationToken.None);
    ...
    public void Should_Always_Throw_OperationCanceledException()
    {
        ...
        {
            ConnectionMethod = ConnectionMethod.ConnectionString,
            ConnectionString = ConnectionString ?? "Invalid",
        };
        var options = DefaultOptions();
        ...
        Func<Task> action = async () => { await AzureTableStorage.CreateTable(input, DefaultConnectionStringConnection(), DefaultOptions(), cts.Token); };
